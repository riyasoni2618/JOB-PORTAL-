        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://linkedin.com" className="hover:text-gray-400" aria-label="LinkedIn">
                <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-9.479c0-2.276-1.13-3.554-3.534-3.554-1.423 0-2.28.679-2.676 1.319h-.096v-1.114h-3.555v12.828h3.555v-8.375c0-.447.071-.894.256-1.218.423-.74 1.341-1.503 2.684-1.503 1.94 0 3.05 1.55 3.05 3.864v9.223h3.554v-9.48c0-2.276-1.13-3.554-3.534-3.554-1.423 0-2.28.679-2.676 1.319h-.096v-1.114h-3.555v12.828h3.555v-8.375c0-.447.071-.894.256-1.218.423-.74 1.341-1.503 2.684-1.503 1.94 0 3.05 1.55 3.05 3.864v9.223h3.554v-9.48zm-15.556-1.921c1.233 0 1.996-.757 1.996-1.782.023-1.025-.757-1.781-1.973-1.781-1.216 0-1.996.756-1.996 1.781 0 1.025.757 1.782 1.973 1.782h.023zm3.554-1.921c0 1.758-1.55 2.56-3.554 2.56h-3.555v-12.828h3.555v10.268zm-3.554 0c-.002.447.071.894.256 1.218.423.74 1.341 1.503 2.684 1.503 1.94 0 3.05 1.55 3.05 3.864v9.223h3.554v-9.48c0-2.276-1.13-3.554-3.534-3.554-1.423 0-2.28.679-2.676 1.319h-.096v-1.114h-3.555v12.828h3.555v-8.375z"/>
              </svg>
            </a>
          </div>
        </div>
